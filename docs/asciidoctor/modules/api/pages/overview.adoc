...
This one statement makes all of the https://www.rubydoc.info/gems/asciidoctor/2.0.9/Asciidoctor[public APIs in Asciidoctor] available to your script or application.
