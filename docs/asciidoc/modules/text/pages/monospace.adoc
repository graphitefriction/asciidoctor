...
Instead, it gets interpretted just like normal text.
...
You can learn about the various passthrough options in xref:subs:pass-macros.adoc[Inline Passthroughs].
