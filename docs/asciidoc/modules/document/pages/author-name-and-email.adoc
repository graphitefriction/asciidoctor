...
The author of a document is listed on the line beneath the xref:title.adoc[document's title].
...
[source]
----
include::example$author.adoc[tag=base]
----
...
[source]
----
include::example$author.adoc[tag=2-mid]
----
...
[source]
----
include::example$author.adoc[tag=attr]
----
...
[source]
----
include::example$author.adoc[tag=multi]
----
