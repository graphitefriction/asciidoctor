...
|{y}
|{n}
|Enables xref:macros:menu-macro.adoc[], xref:macros:keyboard-macro.adoc[], and xref:macros:button-macro.adoc[].
...
|{y}
|{n}
|Turns on xref:toc:toc.adoc[table of contents] and specifies xref:toc:position.adoc[its location].
