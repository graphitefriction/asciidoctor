...
See xref:asciidoctor:manpage:convert-to-man-page.adoc[Man Pages] for details on how structure a man page using AsciiDoc and generate it with Asciidoctor.
