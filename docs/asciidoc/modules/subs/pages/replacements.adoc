...
For inline elements, the built-in values `r` or `replacements` can be applied to the xref:apply-subs-to-text.adoc[inline pass macro] to add the replacements substitution step.
