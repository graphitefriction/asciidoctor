...
The replacements substitution also recognizes {url-html-ref}[HTML and XML character references^] as well as {url-unicode}[decimal and hexadecimal Unicode code points^] and substitutes them for their corresponding decimal form Unicode code point.
...
These attributes and their corresponding output are listed in the xref:attributes:character-replacements.adoc[Character Replacement Attributes Reference Table].
