...
[source]
----
include::example$block.adoc[tag=list-title]
----
...
When Asciidoctor encounters the previous example, it will put the remainder of the content in the document inside the delimited block (without warning, currently).
