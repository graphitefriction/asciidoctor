...
See xref:rouge.adoc[Rouge], xref:coderay.adoc[CodeRay], or xref:pygments.adoc[Pygments] to find installation instructions.
...
Additionally, you can use an xref:directives:include-directives.adoc[include directive] to insert source code into an AsciiDoc document directly from a file.
