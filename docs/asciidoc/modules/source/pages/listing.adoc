...
[source]
----
include::example$listing.adoc[tag=para]
----
...
[source]
....
include::example$listing.adoc[tag=bl]
....
...
....
include::example$listing.adoc[tag=subs]
....
...
include::example$listing.adoc[tag=subs-out]
